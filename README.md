...
The core [PostHog](./src/PostHog/README.md) package targets `netstandard2.1` and `net8.0` for broad compatibility. The [PostHog.AspNetCore](src/PostHog.AspNetCore/README.md) and [PostHog.AI](src/PostHog.AI/README.md) packages target `net8.0`.
